...
{{--											<span>--}}
{{--												<img src="{{ asset('/') }}backend/build/assets/images/flags/french_flag.jpg" alt="img" class="avatar avatar-xs lh-1 me-2">--}}
{{--											</span>--}}
{{--                            French--}}
{{--                        </a>--}}
{{--                    </li>--}}
...
{{--                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">--}}
{{--											<span>--}}
{{--												<img src="{{ asset('/') }}backend/build/assets/images/flags/germany_flag.jpg" alt="img" class="avatar avatar-xs lh-1 me-2">--}}
{{--											</span>--}}
{{--                            German--}}
{{--                        </a>--}}
{{--                    </li>--}}
...
{{--                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">--}}
{{--											<span>--}}
{{--												<img src="{{ asset('/') }}backend/build/assets/images/flags/italy_flag.jpg" alt="img" class="avatar avatar-xs lh-1 me-2">--}}
{{--											</span>--}}
{{--                            Italian--}}
{{--                        </a>--}}
{{--                    </li>--}}
...
{{--                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">--}}
{{--											<span>--}}
{{--												<img src="{{ asset('/') }}backend/build/assets/images/flags/russia_flag.jpg" alt="img" class="avatar avatar-xs lh-1 me-2">--}}
{{--											</span>--}}
{{--                            Russian--}}
{{--                        </a>--}}
{{--                    </li>--}}
...
{{--                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">--}}
{{--											<span>--}}
{{--												<img src="{{ asset('/') }}backend/build/assets/images/flags/spain_flag.jpg" alt="img" class="avatar avatar-xs lh-1 me-2">--}}
{{--											</span>--}}
{{--                            Spanish--}}
{{--                        </a>--}}
{{--                    </li>--}}
...
{{--													<img src="{{ asset('/') }}backend/build/assets/images/faces/12.jpg" alt="img">--}}
{{--												</span>--}}
{{--                                <div>--}}
{{--                                    <div class="d-flex">--}}
...
{{--                            <div class="d-flex messages">--}}
{{--												<span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">--}}
{{--													<img src="{{ asset('/') }}backend/build/assets/images/faces/3.jpg" alt="img">--}}
{{--												</span>--}}
{{--                                <div>--}}
{{--                                    <div class="d-flex">--}}
...
{{--                            <div class="d-flex messages">--}}
{{--												<span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">--}}
{{--													<img src="{{ asset('/') }}backend/build/assets/images/faces/5.jpg" alt="img">--}}
{{--												</span>--}}
{{--                                <div>--}}
{{--                                    <div class="d-flex">--}}
...
{{--                            <div class="d-flex messages">--}}
{{--												<span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">--}}
{{--													<img src="{{ asset('/') }}backend/build/assets/images/faces/4.jpg" alt="img">--}}
{{--												</span>--}}
{{--                                <div>--}}
{{--                                    <div class="d-flex">--}}
...
{{--                            <div class="d-flex messages">--}}
{{--												<span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">--}}
{{--													<img src="{{ asset('/') }}backend/build/assets/images/faces/1.jpg" alt="img">--}}
{{--												</span>--}}
{{--                                <div>--}}
{{--                                    <div class="d-flex">--}}
                ...
                <ul class="main-header-dropdown dropdown-menu pt-0 header-profile-dropdown dropdown-menu-end main-profile-menu" aria-labelledby="mainHeaderProfile">
                    <li>
                        <div class="main-header-profile bg-primary menu-header-content text-fixed-white">
                            <div class="my-auto">
                                <h6 class="mb-0 lh-1 text-fixed-white">{{ auth()->user()->name ?? 'User' }}</h6>{{--<span class="fs-11 op-7 lh-1">Premium Member</span>--}}
                            </div>
                        </div>
                    </li>
